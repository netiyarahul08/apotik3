...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="{{ route('penjualan.update', $record->id) }}" class="form-horizontal" method="POST"
            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="form-group @if($errors->has('customer')) has-error @endif">
                        ...
                        <div class="col-md-4" id="groupcustomer">

                            <select class="form-control" id="customer" name="customer" value="{{ old('customer') }}">
                                @foreach($customer as $item)
                                <option value="{{$item->id}}" @if($item->id == $record->id_customer) selected
...
<script>
    ...
    var produk = {!!$produk!!};
    var detailProduk = {!!$record->penjualanDetail!!}
    renderDetailProduk();
    function renderDetailProduk(){
        ...
        detailProduk.forEach(function(item, index){
            ...
            produk.forEach(function(itemProduk, indexProduk){
                $("#produk-"+index).append('<option value="'+itemProduk.id+'" data-harga="'+itemProduk.harga_jual+'">'+itemProduk.nama+'</option>');
            });
