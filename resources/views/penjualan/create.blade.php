...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="{{ route('penjualan.store') }}" class="form-horizontal" enctype="multipart/form-data"
            method="POST">
                    ...
                    <div class="form-group @if($errors->has('customer')) has-error @endif">
                        ...
                        <div class="col-md-4" id="groupcustomer">
                            ...
                            <select class="form-control" id="customer" name="customer" value="{{ old('customer') }}">
                                ...
                                <option value="{{$item->id}}" @if($item->id == old('customer')) selected
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th class="form-group  @if($errors->has('total')) has-error @endif"
                                    id="grouptotal">
