...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="{{ route('produk.update', $record->id) }}" class="form-horizontal" method="POST"
                    ...
                    <div class="form-group @if($errors->has('jenis')) has-error @endif">
                        ...
                        <div class="col-md-10" id="groupjenis">
                            <select name="jenis" id="jenis" class="form-control">
                                ...
                                <option value="{{$item->id}}" @if($record->id_jenis == $item->id) selected @endif>{{$item->nama}}</option>
                                @endforeach
