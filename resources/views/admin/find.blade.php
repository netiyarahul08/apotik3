...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-body">
                <form action="{{ route('admin.update', $record->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group @if($errors->has('avatar')) has-error @endif">
                            ...
                            <br>
                            <img src="{{$record->avatar}}" alt="" id="img-avatar" style="height : 96px"
                                class="img-thumbnail">
